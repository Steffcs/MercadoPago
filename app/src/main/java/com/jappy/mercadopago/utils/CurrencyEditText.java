...
public class CurrencyEditText extends AppCompatEditText {
    ...
    /**
     * When currency empty <br/> + When focus EditText, set the default text = prefix (ex: VND) <br/> + When EditText lose focus, set the default text = "",
     * EditText will display hint (ex:VND)
     */
    ...
    private static class CurrencyTextWatcher implements TextWatcher {
        ...
        /**
         * It will return suitable pattern for format decimal For example: 10.2 -> return 0 | 10.23 -> return 00, | 10.235 -> return 000
         */
